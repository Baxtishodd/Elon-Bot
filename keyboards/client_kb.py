...
States_kb.row(b_cancel, b_clear)
...
Fargona_kb.row(b_cancel, b_clear)
...
Jizzax_kb.row(b_cancel, b_clear)
...
Namangan_kb.row(b_cancel, b_clear)
...
Navoiy_kb.row(b_cancel, b_clear)
...
Qashqadaryo_kb.row(b_cancel, b_clear)
...
Qoraqalpogiston_kb.row(b_cancel, b_clear)
...
Samarqand_kb.row(b_cancel, b_clear)
...
Sirdaryo_kb.row(b_cancel, b_clear)
...
Surxandaryo_kb.row(b_cancel, b_clear)
...
#                 'qibray',#                 'zomin',
#                 'quyi_chirchiq',
#                 'yuqori_chirchiq'          'o`rta_chirchiq',
#                 'oqqo`rg`on',               'chinoz',
#
#                 ]
...
Toshkent_kb.row(b_cancel, b_clear)
...
Xorazm_kb.row(xob11)
Xorazm_kb.row(b_cancel, b_clear)
...
Toshkent_shkb.row(b_cancel, b_clear)
